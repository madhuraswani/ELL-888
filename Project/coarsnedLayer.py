...
class Coarsened(tf.keras.layers.Layer):
  ...
  Attributes:
    n_outputs: Number of clusters in the model.
  ...
  def __init__(self,
    ...
    super(Coarsened, self).__init__()
    self.n_outputs = n_ops
  ...
  def build(self, input_shape):
    ...
    super(Coarsened, self).build(input_shape)
  ...
  def call(
    ...
    assignments = tf.keras.activations.sigmoid(self.transform(features), axis=1)
